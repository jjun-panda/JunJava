...
public class ComTest extends JPanel implements ActionListener {
    JFrame f;
    ...
    private static final String SELECT_QUESTIONS_QUERY = "SELECT * FROM comquiz";
